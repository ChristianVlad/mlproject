...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            logging.info("Numerical columns standar scalling completed: {numerical_columns}")
            logging.info("Categorical columns encodign completed: {categorical_columns}")
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info("Aplying preprocessor object on training dataframe")
